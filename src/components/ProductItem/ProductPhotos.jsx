...
//     "/images/product/product_img_07.jpg"
//   );
...
//         <div className="w-full max-h-[450px] max-w-[450px] flex justify-center ">
//           {isVideoPlaying ? (
//             <video
//               className="object-cover h-full max-h-[450px] max-w-[450px]  w-full"
//               ref={videoRef}
//               src={currentImageURL}
//               alt="Product video"
//               controls
...
//           )}
//         </div>
//         <div className="flex flex-row mt-[120px] ml-6">
//           <img
//             className="w-24 h-24 cursor-pointer mr-4 zoom-image"
//             src="/images/product/product_img_06.jpg"
//             alt="Product image 1"
//             onClick={() =>
//               handleImageClick("/images/product/product_img_06.jpg")
//             }
//           />
//           <img
//             className="w-24 h-24 cursor-pointer mr-4 zoom-image"
...
//           <img
//             className="w-24 h-24 cursor-pointer mr-4 zoom-image"
//             src="/images/product/product_img_05.jpg"
//             alt="Product image 4"
//             onClick={() =>
//               handleImageClick("/images/product/product_img_05.jpg")
//             }
//           />
  ...
  return (
    <div className="section sm:px-4 sm:py-8 sm:overflow-x-hidden">
      ...
      <div className="flex-col justify-center pl-4 hidden sm:flex">
          ...
          {isVideoPlaying ? (
            ...
            <ReactImageMagnify
              ...
              style={{
                ...
                maxWidth: "400px",
                marginBottom: "1rem",
              }} // Adjust max height and width
              smallImage={{
                alt: "Product image",
                isFluidWidth: true,
                src: currentImageURL,
                style: { maxHeight: "400px", maxWidth: "400px" }, // Adjust max height and width
              }}
              largeImage={{
                src: currentImageURL,
                width: 400,
        ...
        <div className="flex flex-row mt-[80px] ml-0">
          <img
            className="w-24 h-24 cursor-pointer mr-4 zoom-image"
            src="/images/product/product_img_06.jpg"
            alt="Product image 1"
